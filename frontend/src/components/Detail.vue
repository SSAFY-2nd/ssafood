        ...
        <div class="detail">
            <div class="content">
              <div class="header-image">
                  <img :src="require(`@/assets/img/${restaurant.store_id}.jpg`)" width="500" height="300" >
              </div>
            ...
            <div class = "right-side">
               <div id="map"></div> 
                ...
                <table v-for="(listdata,index) in around_list" :key="index">
                    ...
                    <tr>
                        <td rowspan=3><img :src="require(`@/assets/img/${listdata.store_id}.jpg`)" width="70" height="70"></td>
